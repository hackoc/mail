...
export const text = ({ firstName }) => `Thanks for registering, ${firstName}! We'll reach out to you soon to sign the event liability waiver. In the meantime, join our Discord server (https://hackoc.org/discord) to chat with other hackers.
Cheers,
Ian & the Hack OC team
-----
